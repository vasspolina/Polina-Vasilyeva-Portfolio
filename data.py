 ...
 },
 {
  ...
  "pages": [
    ...
    ("IMG", "alexander-wang/resealable-bags.png",
     "Packaging — resealable briefs bags in three sizes", ["brand"],
     {"crop": False, "split": False}),
    ("IMG", "alexander-wang/retail-display-trays.png",
     "Retail display — cartons and pouches on red trays", ["brand"],
     {"crop": False, "split": False}),
    ("IMG", "alexander-wang/display-case.png",
     "Bodywear display case — packs stacked behind glass", ["brand"],
     {"crop": False, "split": False}),
